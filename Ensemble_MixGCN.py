...
def get_parser():
    ...
    parser.add_argument(
        '--ctrgcn_J2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_J/epoch1_test_score.pkl')
    parser.add_argument(
        '--ctrgcn_B2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_B/epoch1_test_score.pkl')
    parser.add_argument(
        '--ctrgcn_JM2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_JM/epoch1_test_score.pkl')
    parser.add_argument(
        '--ctrgcn_BM2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_BM/epoch1_test_score.pkl')
    parser.add_argument(
        '--ctrgcn_J3d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_J_3D/epoch1_test_score.pkl'),
    parser.add_argument(
        '--ctrgcn_B3d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_B_3D/epoch1_test_score.pkl'),
    parser.add_argument(
        '--ctrgcn_JM3d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_JM_3D/epoch1_test_score.pkl'),
    parser.add_argument(
        '--ctrgcn_BM3d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/ctrgcn_V2_BM_3D/epoch1_test_score.pkl'),
    parser.add_argument(
        '--tdgcn_J2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/tdgcn_V2_J/epoch1_test_score.pkl'),
    parser.add_argument(
        '--tdgcn_B2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/tdgcn_V2_B/epoch1_test_score.pkl'),
    parser.add_argument(
        '--tdgcn_JM2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/tdgcn_V2_JM/epoch1_test_score.pkl'),
    parser.add_argument(
        '--tdgcn_BM2d_Score', 
        type = str,
        default = './Model_inference/Mix_GCN/output/tdgcn_V2_BM/epoch1_test_score.pkl'),
    parser.add_argument(
        '--val_sample', 
        type = str,
...
if __name__ == "__main__":
    ...
    File = [j_file, b_file, jm_file, bm_file, j3d_file, b3d_file, jm3d_file, bm3d_file, td_j_file, td_b_file, td_jm_file, td_bm_file]    
    if args.benchmark == 'V1':
        Numclass = 155
        Sample_Num = 6307
        Rate = [0.7, 0.7, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.7, 0.7, 0.3, 0.3] 
